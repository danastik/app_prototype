...
class AudioEngine:
    ...
    def _load_audio(self, path):
        ...
        with self.archive.open(path) as file:
            ...
            print(
                f"[Audio] archive.open(): "
                f"{open_time * 1000:.2f} ms"
            )
        ...
        if sr != self.sample_rate:
            ...
            print(
                f"[Audio] Sample-rate conversion: "
                f"{resample_time * 1000:.2f} ms"
            )
    ...
    def load_all_sounds(self):
        ...
        for sound_name, cfg in (
            self.sounds_config.items()
        ):
